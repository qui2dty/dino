...
class Score {
  ...
  setBackgroundColor() {
    const stageCheck = this.currentStage - 999;
    ...
    switch (stageCheck) {
      case 1:
        ...
        break;
      case 2:
        this.ctx.fillStyle = '#85E8FE';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      case 3:
        this.ctx.fillStyle = '#B8D5B8';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      case 4:
        this.ctx.fillStyle = '#fab350';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      case 5:
        this.ctx.fillStyle = '#F7934C';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      case 6:
        this.ctx.fillStyle = '#654597';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      case 7:
        this.ctx.fillStyle = '#222A68';
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        break;
      default:
        break;
